...
If using structured directories, then uncomment the line `include: "/usr/local/unbound/conf.d/*.conf"` [`unbound.conf`](https://raw.githubusercontent.com/madnuttah/unbound-docker/main/unbound/root/usr/local/unbound/unbound.conf)

You can verify the connection to redis in the `unbound.log` or by typing `docker logs unbound` in the shell: 

```
...
May 26 21:19:49 unbound[1:0] notice: init module 0: validator
May 26 21:19:49 unbound[1:0] notice: init module 1: cachedb
May 26 21:19:49 unbound[1:0] notice: Redis initialization
May 26 21:19:49 unbound[1:0] notice: Connection to Redis established
May 26 21:19:49 unbound[1:0] notice: init module 2: iterator
...
```
